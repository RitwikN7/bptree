...
void createRelationForwardTest(int rel = relationSize);
void createRelationBackwardTest(int rel = relationSize);
void createRelationRandom();
void createRelationRandomTest(int rel = relationSize);
...
void test5() {
  std::cout << "---------------------" << std::endl;
  std::cout << "Test non-contiguous random stress." << std::endl;
...
void test6() {
  std::cout << "---------------------" << std::endl;
  std::cout << "Test contiguous ascending stress." << std::endl;
  createRelationForwardTest(350000);
  intTests();
  deleteIndexFile();
  deleteRelation();
}
...
{
  std::cout << "---------------------" << std::endl;
  std::cout << "Test contiguous descending stress." << std::endl;
  createRelationBackwardTest(350000);
  intTests();
  deleteIndexFile();
  deleteRelation();
}
...
void test8() {
  std::cout << "---------------------" << std::endl;
  std::cout << "Test contiguous random stress." << std::endl;
  createRelationRandomTest(350000);
  intTests();
  deleteIndexFile();
  deleteRelation();
}
...
void createRelationForwardTest(int relationSize) {
  std::vector<RecordId> ridVec;
  // destroy old copies of relation file
  try {
    File::remove(relationName);
...
void createRelationBackwardTest(int relationSize) {
...
void createRelationRandomTest(int relationSize) {
  // destroy any old copies of relation file
  try {
    File::remove(relationName);
  } catch (FileNotFoundException e) {
